...
if ( ! class_exists( 'Techloop_Widget_Area' ) ) {

	/**
	 * Class Techloop_Widget_Area.
	 */
	class Techloop_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'techloop_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'techloop_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'techloop_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function techloop_widget_area() {
		return Techloop_Widget_Area::get_instance();
	}

	techloop_widget_area();
}
