 ...
 */
add_filter( 'template_include', array( 'Techloop_Wrapping', 'wrap' ), 99 );
add_filter( 'techloop_wrap_base', 'techloop_wrap_base_cpts' );
 ...
 */
function techloop_template_path() {
	return Techloop_Wrapping::$main_template;
}
 ...
 */
function techloop_template_base() {
	return Techloop_Wrapping::$base;
}

if ( ! class_exists( 'Techloop_Wrapping' ) ) {
	...
	class Techloop_Wrapping {
		...
		/**
		 * Initialize new instance of Techloop_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'techloop_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Techloop_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function techloop_wrap_base_cpts( $templates ) {
