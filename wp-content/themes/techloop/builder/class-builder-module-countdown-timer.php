...
/**
 * Class Techloop_Builder_Module_Countdown_Timer.
 */
class Techloop_Builder_Module_Countdown_Timer extends Tm_Builder_Module {

	public $function_name;

	public function init() {
		$this->name = esc_html__( 'Countdown Timer', 'techloop' );
		...
		$this->advanced_options = array(
			'fonts' => array(
				...
				'numbers' => array(
					'label'    => esc_html__( 'Numbers', 'techloop' ),
					'css'      => array(
				...
				'label' => array(
					'label'    => esc_html__( 'Label', 'techloop' ),
					'css'      => array(
		...
		$this->custom_css_options = array(
			'container' => array(
				'label'    => esc_html__( 'Container', 'techloop' ),
			...
			'timer_section' => array(
				'label'    => esc_html__( 'Timer Section', 'techloop' ),
				'selector' => '.section',
			),
		);
	}
	...
	public function get_fields() {
		$fields = array(
			'title' => array(
				'label'           => esc_html__( 'Countdown Timer Title', 'techloop' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'This is the title displayed for the countdown timer.', 'techloop' ),
			),
			'date_time' => array(
				'label'           => esc_html__( 'Countdown To', 'techloop' ),
				'type'            => 'date_picker',
				'option_category' => 'basic_option',
				'description'     => tm_get_safe_localization(
					sprintf(
						...
						esc_html__( 'This is the date the countdown timer is counting down to. Your countdown timer is based on your timezone settings in your ', 'techloop' ),
						esc_html__( 'WordPress General Settings', 'techloop' )
					)
				),
			),
			'use_background_color' => array(
				'label'           => esc_html__( 'Use Background Color', 'techloop' ),
				'type'            => 'yes_no_button',
				...
				'description' => esc_html__( 'Here you can choose whether background color setting below should be used or not.', 'techloop' ),
			),
			'background_color' => array(
				'label'             => esc_html__( 'Background Color', 'techloop' ),
				'type'              => 'color-alpha',
				'depends_default'   => true,
				'description'       => esc_html__( 'Here you can define a custom background color for your countdown timer.', 'techloop' ),
			),
			'timer_layout' => array(
				'label'             => esc_html__( 'Layout', 'techloop' ),
				'type'              => 'select',
				'options'           => array(
					'flat'   => esc_html__( 'Flat', 'techloop' ),
					'circle' => esc_html__( 'Circle', 'techloop' ),
				),
				'affects'           => array(
			...
			'circle_background' => array(
				'label'               => esc_html__( 'Circle Background Color', 'techloop' ),
				'type'                => 'color-alpha',
			...
			'use_circle_border' => array(
				'label'           => esc_html__( 'Use Circle Border', 'techloop' ),
				'type'            => 'yes_no_button',
			...
			'disabled_on' => array(
				...
				'options'         => array(
					'phone'   => esc_html__( 'Phone', 'techloop' ),
					'tablet'  => esc_html__( 'Tablet', 'techloop' ),
					'desktop' => esc_html__( 'Desktop', 'techloop' ),
				),
...
new Techloop_Builder_Module_Countdown_Timer;
