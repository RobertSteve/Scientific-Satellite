<?php
class Techloop_Builder_Module_Pricing_Tables extends Tm_Builder_Module {
	public function init() {

		$this->name             = esc_html__( 'Pricing Tables', 'techloop' );
		$this->slug             = 'tm_pb_pricing_tables';
		$this->icon             = 'f0ce';
		$this->main_css_element = '%%order_class%%.tm_pb_pricing';
		$this->child_slug       = 'tm_pb_pricing_table';
		$this->child_item_text  = esc_html__( 'Pricing Table', 'techloop' );
		...
		$this->custom_css_options = array(
			...
			'featured_table' => array(
				'label'    => esc_html__( 'Featured Table', 'techloop' ),
	...
	public function get_fields() {
		$fields = array(
			'featured_table_background_color' => array(
				'label'             => esc_html__( 'Featured Table Background Color', 'techloop' ),
				'type'              => 'color-alpha',
				'custom_color'      => true,
				'tab_slug'          => 'advanced',
				'priority'          => 23,
			...
			'header_background_color' => array(
				'label'             => esc_html__( 'Table Header Background Color', 'techloop' ),
				'type'              => 'color-alpha',
				'custom_color'      => true,
				'tab_slug'          => 'advanced',
			),
			'featured_table_header_background_color' => array(
				'label'             => esc_html__( 'Featured Table Header Background Color', 'techloop' ),
				'type'              => 'color-alpha',
				'custom_color'      => true,
				'tab_slug'          => 'advanced',
				'priority'          => 21,
			...
			'featured_table_header_text_color' => array(
				'label'             => esc_html__( 'Featured Table Header Text Color', 'techloop' ),
				'type'              => 'color-alpha',
				'custom_color'      => true,
				'tab_slug'          => 'advanced',
				'priority'          => 20,
			...
			'featured_table_subheader_text_color' => array(
				'label'             => esc_html__( 'Featured Table Subheader Text Color', 'techloop' ),
				'type'              => 'color-alpha',
				'custom_color'      => true,
				'tab_slug'          => 'advanced',
				'priority'          => 20,
			...
			'featured_table_price_color' => array(
				'label'             => esc_html__( 'Featured Table Price Color', 'techloop' ),
				'type'              => 'color-alpha',
				'custom_color'      => true,
				'tab_slug'          => 'advanced',
				'priority'          => 20,
			...
			'featured_table_text_color' => array(
				'label'             => esc_html__( 'Featured Table Body Text Color', 'techloop' ),
				'type'              => 'color-alpha',
				'custom_color'      => true,
				'tab_slug'          => 'advanced',
				'priority'          => 22,
			...
			'show_bullet' => array(
				'label'           => esc_html__( 'Show Bullet', 'techloop' ),
				'type'            => 'yes_no_button',
			...
			'bullet_color' => array(
				'label'             => esc_html__( 'Bullet Color', 'techloop' ),
				'type'              => 'color-alpha',
				'custom_color'      => true,
				'tab_slug'          => 'advanced',
				'depends_show_if'   => 'on',
			...
			'featured_table_bullet_color' => array(
				'label'             => esc_html__( 'Featured Table Bullet Color', 'techloop' ),
				'type'              => 'color-alpha',
				'custom_color'      => true,
				'tab_slug'          => 'advanced',
				'priority'          => 22,
			...
			'remove_featured_drop_shadow' => array(
				'label'           => esc_html__( 'Remove Featured Table Drop Shadow', 'techloop' ),
				'type'            => 'yes_no_button',
				'option_category' => 'layout',
				'options'         => array(
					'off' => esc_html__( 'No', 'techloop' ),
			...
			'center_list_items' => array(
				'label'           => esc_html__( 'Center List Items', 'techloop' ),
				'type'            => 'yes_no_button',
				'option_category' => 'layout',
				'options'         => array(
					'off' => esc_html__( 'No', 'techloop' ),
			...
			'admin_label' => array(
				'label'       => esc_html__( 'Admin Label', 'techloop' ),
				'type'        => 'text',
				'description' => esc_html__( 'This will change the label of the module in the builder for easy identification.', 'techloop' ),
			),
			'module_id' => array(
	...
	public function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		if ( '' !== $featured_table_header_text_color ) {
			TM_Builder_Element::set_style( $function_name, array(
				'selector'    => '%%order_class%% .tm_pb_featured_table .tm_pb_pricing_heading h3',
				'declaration' => sprintf(
					'color: %1$s;',
	...
	public function additional_shortcode_callback( $atts, $content = null, $function_name ) {
...
new Techloop_Builder_Module_Pricing_Tables;
