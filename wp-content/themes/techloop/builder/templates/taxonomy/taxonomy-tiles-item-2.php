...
$image   = tm_builder_core()->utility()->media->get_image(
	apply_filters( 'tm_pb_module_taxonomy_img_settings_grid_item', array(
		'size'  => 'post-thumbnail',
		'class' => 'term-img',
		'html'  => '<a href="%1$s" title="%4$s"><span %2$s title="%4$s" style="background-image:url(%3$s); padding:0 0 76.4%% 0;"></span></a>',
	) ), 'term', $term_id );
?>
