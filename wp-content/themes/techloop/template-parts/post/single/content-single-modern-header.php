...
<div class="single-modern-header <?php echo $invert_class = has_post_thumbnail() ? 'invert' : ''; ?>">
	...
	<div class="container">
		...
		<header class="entry-header">
			...
			$avatar               = get_avatar( get_the_author_meta( 'user_email' ), 160, '', esc_attr( get_the_author_meta( 'nickname' ) ) );
		...
		<?php if ( 'post' === get_post_type() ) : ?>
			...
			<div class="entry-meta">
				...
				<?php $cats_visible = techloop_is_meta_visible( 'single_post_categories', 'single' );
